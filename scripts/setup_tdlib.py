...
def main():
    ...
    parser.add_argument(
        "--info", action="store_true", help="Show platform and library information"
    )
    parser.add_argument(
        "--validate", action="store_true", help="Validate current library setup"
    )
...
def validate_setup(manager):
    ...
    if is_valid:
        ...
        print("✓ All library dependencies are satisfied")
        sys.exit(0)
    else:
        ...
        platform_name, _ = manager.platform_info
